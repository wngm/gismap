...
// })
gisMap.viewer.clock.currentTime = Cesium.JulianDate.addHours(Cesium.JulianDate.now(new Date()), 4, new Cesium.JulianDate());
...
return (
    <div className="box">
      ...
      <div className="btn" onClick={imageRenderingClose} role="none">像素化处理 关闭</div>
      ...
      <div className="btn" onClick={updatePostProcessOff} role="none">泛光 关闭</div>
    </div>
  );
}
